...
public class RockPaperScissors extends JPanel implements ActionListener {
	...
	public void actionPerformed(ActionEvent e) {
		...
		// 1. Run the program and play many rounds of Rock Paper Scissors. Does the
		// computer always choose the same thing?
		// yes
		// 2. Change the value of opponentSelection to be a random number between 0 and
		// 2;
